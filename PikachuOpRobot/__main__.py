...
PM_START_TEXT = f"""
`𝐇𝐢..𝐖𝐞𝐥𝐜𝐨𝐦𝐞` [😎](https://telegra.ph/file/73c029c8cb9948a506249.jpg)
`𝐈'𝐦` black Goku 🤗
...
HELP_STRINGS = f"""
`𝐇𝐢.. 𝐈'𝐦` black Goku [😎](https://telegra.ph/file/73c029c8cb9948a506249.jpg)
`𝐂𝐥𝐢𝐜𝐤 𝐨𝐧 𝐭𝐡𝐞 𝐛𝐮𝐭𝐭𝐨𝐧𝐬 𝐛𝐞𝐥𝐨𝐰 𝐭𝐨 𝐠𝐞𝐭 𝐝𝐨𝐜𝐮𝐦𝐞𝐧𝐭𝐚𝐭𝐢𝐨𝐧 𝐚𝐛𝐨𝐮𝐭 m𝐨𝐝𝐮𝐥𝐞𝐬..`"""
...
def start(update, context):
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text("𝐇𝐞𝐲𝐚..., black Goku 🔥 𝐇𝐞𝐫𝐞,𝐇𝐨𝐰 𝐂𝐚𝐧 𝐈 𝐇𝐞𝐥𝐩 𝐘𝐨𝐮? 🧐")
